...
HD_PWD='E:/riscV/riscV.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tinyriscv_soc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tinyriscv_soc_top.tcl -notrace
