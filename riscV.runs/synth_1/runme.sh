...
HD_PWD='E:/riscV/riscV.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tinyriscv_soc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tinyriscv_soc_top.tcl
